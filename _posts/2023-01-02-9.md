...
excerpt: "XAI는 AI가 내린 결정을 사람이 이해하는 형태로 설명하고 제시할 수 있는 기술을 말합니다. XAI 개념 정리 및 GradCAM 실습해본 경험을 공유합니다."
---
...
[관련 소스 Github 링크](https://github.com/juhonamnam/data-analysis/blob/main/xai/xai.ipynb)
